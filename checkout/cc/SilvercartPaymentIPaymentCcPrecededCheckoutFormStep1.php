...
/**
 * Second form step for iPayment Credit Card payment.
 *
 * @package Silvercart
 * @subpackage Forms
 ...
 */
class SilvercartPaymentIPaymentCcPrecededCheckoutFormStep1 extends SilvercartPaymentIPaymentCheckoutFormStepProcessOrder {
}